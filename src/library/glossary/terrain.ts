const Cracked =
  "Cracked terrain forces anything attempting to step \
off of it to make an Endurance check or become Staggered.";

const Grass =
  "Wood Navis and Viruses regain HP equal to their \
...
const Ice =
  "Should a target use a Move Action to enter a space of this type, \
...
const Lava =
  "Any target save those of the Fire Element that steps on \
...
const Magnet =
  "Any target save those of the Elec Element are propelled \
...
const Metal =
  "These spaces are immune to becoming Cracked \
by any sort of attack, and targets that stand on them have \
their AC increased by 2";

const Poison =
  "Targets standing on Poison terrain immediately \
...
const Sand =
  "Targets stepping onto terrain of this type \
...
const Sea =
  "Terrain of this type forces targets \
