const Affinity =
  "For Operators, Affinity is a mark of how closely bonded to your Navi you are. \
...
const Agility =
  "For both Operators and Navis, Agility is your swiftness of movement. \
...
const Charm =
  "For both Operators and Navis, Charm is used to garner the \
...
const Endurance =
  "For both Operators and Navis, Endurance is used to \
...
const Info =
  "For Operators, Info is used to discern information about \
...
const Perception =
  "For both Operators and Navis, Perception is the skill \
...
const Tech =
  "For Operators, Tech can be used to write programs that do specific \
