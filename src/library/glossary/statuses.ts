const AngryStatus =
  "Angered Navis are reckless and attack with all their might. \
...
const AuraStatus =
  "The Aura status surrounds Navis in a powerful cloak of energy that \
...
const BarrierStatus =
  "Navis with the Barrier status are surrounded in a protective \
...
const BlindStatus =
  "When Blinded, all Attacks Rolls you make against targets \
...
const ConfusionStatus =
  "When Confused, you must make every Movement action available \
...
const FatigueStatus =
  "Fatigued Navis are considered weak against every \
...
const InvisibleStatus =
  "An Invisible target is unable to be seen through \
...
const LockStatus =
  "When you become Locked, you are unable to \
...
const ParalysisStatus =
  "Paralysis prevents you from making any \
...
const ShieldStatus =
  "Targets with the Shield status will often \
...
const StaggerStatus =
  "When Staggered, your AC is reduced by \
