const Burst =
  "Chips of the burst type have their damage \
immediately paint the area they affect. They have \
no line of fire.";

const Construct =
  "Chips of the construct type create an \
...
const Support =
  "Chips of the support type carry \
...
const Trap =
  " Chips of the trap type will usually set \
